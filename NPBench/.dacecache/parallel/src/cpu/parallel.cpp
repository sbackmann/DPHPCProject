...
void __program_parallel_internal(parallel_t *__state, double * __restrict__ u_pos, double * __restrict__ u_stage, double * __restrict__ utens, double * __restrict__ utens_stage, double * __restrict__ wcon, long long I, long long J, long long K, double dtr_stage)
{
    double *__tmp8;
...
DACE_EXPORTED void __program_parallel(parallel_t *__state, double * __restrict__ u_pos, double * __restrict__ u_stage, double * __restrict__ utens, double * __restrict__ utens_stage, double * __restrict__ wcon, long long I, long long J, long long K, double dtr_stage)
{
    __program_parallel_internal(__state, u_pos, u_stage, utens, utens_stage, wcon, I, J, K, dtr_stage);
}

DACE_EXPORTED parallel_t *__dace_init_parallel(long long I, long long J, long long K)
{
    int __result = 0;
    parallel_t *__state = new parallel_t;
...
DACE_EXPORTED int __dace_exit_parallel(parallel_t *__state)
{
    int __err = 0;
    delete __state;
    return __err;
