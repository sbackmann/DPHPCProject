...
int main(int argc, char** argv)
{
  ...
  float alpha;
  float (*imgIn)[4096 + 0][2160 + 0]; imgIn = (float(*)[4096 + 0][2160 + 0])malloc (((4096 + 0) * (2160 + 0))* sizeof(float));;
  float (*imgOut)[4096 + 0][2160 + 0]; imgOut = (float(*)[4096 + 0][2160 + 0])malloc (((4096 + 0) * (2160 + 0))* sizeof(float));;
  float (*y1)[4096 + 0][2160 + 0]; y1 = (float(*)[4096 + 0][2160 + 0])malloc (((4096 + 0) * (2160 + 0))* sizeof(float));;
  float (*y2)[4096 + 0][2160 + 0]; y2 = (float(*)[4096 + 0][2160 + 0])malloc (((4096 + 0) * (2160 + 0))* sizeof(float));;
