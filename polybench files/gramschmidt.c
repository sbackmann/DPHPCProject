...
int main(int argc, char** argv)
{
  ...
  double (*A)[1000 + 0][1200 + 0]; A = (double(*)[1000 + 0][1200 + 0])malloc ((1000 + 0) * (1200 + 0)* sizeof(double));;
  double (*R)[1200 + 0][1200 + 0]; R = (double(*)[1200 + 0][1200 + 0])malloc ((1200 + 0) * (1200 + 0)* sizeof(double));;
  double (*Q)[1000 + 0][1200 + 0]; Q = (double(*)[1000 + 0][1200 + 0])malloc ((1000 + 0) * (1200 + 0)* sizeof(double));;
